                    ...
                    <form name="signupForm1" id="signupForm1" class="form-horizontal" method="POST" autocomplete="off" action="<?php echo url("producto/editar/")?>">
                        <div class="box-body">
                            ...
                            <div class="col-lg-6 form-group">
                                ...
                                <div class="col-xs-9">
                                    <input type="text" class="form-control" id="cantidad" name="cantidad" value="<?php echo $producto->pro_cantidad ?>" >
                                </div>
                            </div>
...
<?php echo $__env->make('plantilla.estructura', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>