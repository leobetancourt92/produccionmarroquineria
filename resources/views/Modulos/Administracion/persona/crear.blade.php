                ...
                <form name="signupForm1" id="signupForm1" class="form-horizontal" method="post" autocomplete="off" action="<?php echo url('persona/crear') ?>">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="Select2-single form-control" name="ciu_id" id="ciu_id" placeholder="Ciudad">
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="Select2-single form-control" name="tip_cli_id" id="tip_cli_id">
