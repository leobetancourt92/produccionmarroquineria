            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo url("persona/crear")?>"><i class="fa fa-circle-o"></i> Crear</a></li>
                            <li><a href="<?php echo url("persona/listar")?>"><i class="fa fa-circle-o"></i> Consultar</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-cog"></i> Empresa <i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                            <li><a href="<?php echo url("empresa/crear")?>"><i class="fa fa-circle-o"></i> Crear</a></li>
                            <li><a href="<?php echo url("empresa/crear")?>"><i class="fa fa-circle-o"></i> Consultar</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
